...
****************************************************************************************************************************
    ...
    s.pod_target_xcconfig = {
        'ENABLE_BITCODE' => 'NO',
        'HEADER_SEARCH_PATHS' => '$(inherited) "${PODS_ROOT}/DJIWidget/Sample Code/DJIWidget/FFmpeg/FFmpeg.framework/Headers" "${PODS_ROOT}/DJIWidget/Sample Code/DJIWidget/FFmpeg/FFmpeg.framework/Headers/libavcodec" "${PODS_ROOT}/DJIWidget/Sample Code/DJIWidget/FFmpeg/FFmpeg.framework/Headers/libavdevice" "${PODS_ROOT}/DJIWidget/Sample Code/DJIWidget/FFmpeg/FFmpeg.framework/Headers/libavfilter" "${PODS_ROOT}/DJIWidget/Sample Code/DJIWidget/FFmpeg/FFmpeg.framework/Headers/libavformat" "${PODS_ROOT}/DJIWidget/Sample Code/DJIWidget/FFmpeg/FFmpeg.framework/Headers/libavresample" "${PODS_ROOT}/DJIWidget/Sample Code/DJIWidget/FFmpeg/FFmpeg.framework/Headers/libavutil" "${PODS_ROOT}/DJIWidget/Sample Code/DJIWidget/FFmpeg/FFmpeg.framework/Headers/libswresample" "${PODS_ROOT}/DJIWidget/Sample Code/DJIWidget/FFmpeg/FFmpeg.framework/Headers/libswscale"',
    }
